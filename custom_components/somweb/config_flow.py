...
async def validate_input(hass: HomeAssistant, data: dict[str, Any]) -> dict[str, str]:
    ...
    if mode == MODE_LOCAL:
        ...
        somweb_client = SomwebClient(
            url, username, password, aiohttp_client.async_get_clientsession(hass))
    else:
    ...
    try:
        ...
        _LOGGER.debug("Connected to SOMweb device with UDI '%s'",
                      somweb_client.udi)
...
class ConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
        ...
        try:
            ...
            if await somweb_client.async_is_alive():
                ...
                if udi:
                    ...
                    _LOGGER.debug("Discovered SOMweb with UDI '%s'", udi)
            await somweb_client.close()
    ...
    async def async_step_discovery_confirm(
        ...
        if user_input is not None:
            ...
            try:
                ...
                _LOGGER.exception(
                    "Unexpected exception during discovery confirm")
    ...
    async def async_step_user(
        ...
        try:
            ...
            _LOGGER.debug("Got UDI '%s' and set '%s'",
                          info["udi"], user_input[CONF_ID])
